...
var maps = {
    classrooms: 'https://maps.ucsc.edu/content/all-classrooms',
    //colleges: 'http://maps.ucsc.edu/content/all-colleges',
    departments: 'https://maps.ucsc.edu/content/academic-departments',
    dining: 'https://maps.ucsc.edu/content/all-dining',
    libraries: 'https://maps.ucsc.edu/content/all-libraries'
};
...
var secureRequest = function(url, data, jar) {
    ...
    return new Promise(function(resolve, reject) {
        ...
        if (process.env.SOCKS) {
            ...
            obj.agentOptions.socksUsername = process.env.SOCKS_USER
            obj.agentOptions.socksPassword = process.env.SOCKS_PASS
        }
        if (process.env.BIND) {
...
var anonSecureRequest = function(url) {
    return new Promise(function(resolve, reject) {
        var obj = {
            method: 'GET',
            url: url,
...
var searchOnRateMyProfessorRawDom = function(firstName, lastName) {
    return anonSecureRequest('https://www.ratemyprofessors.com/search.jsp?query=' + encodeURIComponent([firstName, lastName].join(' ')));
}

var fetchRateMyProfessorRawDom = function(tid) {
    return anonSecureRequest('https://www.ratemyprofessors.com/ShowRatings.jsp?tid=' + tid)
}
